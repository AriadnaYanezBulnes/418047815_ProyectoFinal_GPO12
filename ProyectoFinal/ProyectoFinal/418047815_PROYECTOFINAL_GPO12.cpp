...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Proyecto Final // Yañez Bulnes Ariadna", nullptr, nullptr);
...
//Carga del parque-escenario / Load of the park-stage
    ...
    Model persona1Cabeza((char*)"Models/personlego/person1Cabeza.obj");
    Model persona1Cuerpo((char*)"Models/personlego/person1Cuerpo.obj");
    Model persona2CaraCuerpo((char*)"Models/personlego/person2CaraCuerpo.obj");
    Model persona2BrazoD((char*)"Models/personlego/person2BrazoD.obj");
    Model persona2BrazoI((char*)"Models/personlego/person2BrazoI.obj");
    Model persona2PiernaI((char*)"Models/personlego/person2PiernaI.obj");
    Model persona2PiernaD((char*)"Models/personlego/person2PiernaD.obj");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
          ...
          model = glm::rotate(model, glm::radians(-rot), glm::vec3(1.0f, 0.0f, 0.0f));
          glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
          mezclador.Draw(shader);
          model = glm::mat4(1);
          model = glm::rotate(model, glm::radians(-rot), glm::vec3(1.0f, 0.0f, 0.0f));
          glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
          persona1Cabeza.Draw(shader);
          model = glm::mat4(1);
          model = glm::rotate(model, glm::radians(-rot), glm::vec3(1.0f, 0.0f, 0.0f));
          glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
          persona1Cuerpo.Draw(shader);
          model = glm::mat4(1);
          model = glm::rotate(model, glm::radians(-rot), glm::vec3(1.0f, 0.0f, 0.0f));
          glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
          persona2CaraCuerpo.Draw(shader);
          model = glm::mat4(1);
          model = glm::rotate(model, glm::radians(-rot), glm::vec3(1.0f, 0.0f, 0.0f));
          glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
          persona2BrazoD.Draw(shader);
          model = glm::mat4(1);
          model = glm::rotate(model, glm::radians(-rot), glm::vec3(1.0f, 0.0f, 0.0f));
          glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
          persona2BrazoI.Draw(shader);
          model = glm::mat4(1);
          model = glm::rotate(model, glm::radians(-rot), glm::vec3(1.0f, 0.0f, 0.0f));
          glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
          persona2PiernaD.Draw(shader);
          model = glm::mat4(1);
          model = glm::rotate(model, glm::radians(-rot), glm::vec3(1.0f, 0.0f, 0.0f));
          glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
          persona2PiernaI.Draw(shader);
